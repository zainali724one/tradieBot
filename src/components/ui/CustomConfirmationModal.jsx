    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-[#D3DCE5] rounded-lg shadow-xl w-11/12 md:max-w-md mx-auto p-6 relative">
        ...
        <div className="flex flex-col space-y-3">
          <PrimaryButton
            onClick={onConfirm}
            color="red" // Use the "red" color prop for the delete button
            loading={confirmButtonLoading}
            loadingText={confirmButtonLoadingText}
            className="py-3 px-4 rounded-lg" // Additional Tailwind classes for padding and rounded corners
          >
            {confirmButtonText}
          </PrimaryButton>
          ...
          <PrimaryButton
            onClick={onClose}
            color="blue" // Use a "blue" color prop for the cancel button
